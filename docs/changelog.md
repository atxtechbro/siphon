...
## [1.4.0](https://github.com/atxtechbro/siphon/compare/v1.3.3...v1.4.0) (2024-12-01)

### Features

* **tokenizer:** add support for token count estimation ([e1a2b3c](https://github.com/atxtechbro/siphon/commit/e1a2b3c4d5e6f7a8b9c0d1e2f3a4b5c6d7e8f9a0))

### Bug Fixes

* **docs:** update documentation for new token count estimation feature ([f2a3b4c](https://github.com/atxtechbro/siphon/commit/f2a3b4c5d6e7f8a9b0c1d2e3f4a5b6c7d8e9f0a1))
